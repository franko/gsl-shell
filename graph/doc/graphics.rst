...
The graph module provides a set of functions that let you easily produce plots
on many kinds or animations.
...
Here a simple example to plot the function above using the "grpah" module.
...
If you want you can set ot change the title of the plot by using its "title"
fields:

  p.title = "Some plotting tests"

You can also save the plot as an image using the :meth:`~Plot.save` method:: 

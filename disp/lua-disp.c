...
#define check_disp(L) (struct disp *) luaL_checkudata (L, 1, disp_mt_name)
...
get_sample (lua_State *L)
{
  ...
  sample = DISP(d)->sampling_intfc->get_sample (d, index);

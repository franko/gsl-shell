...
openblas_complex_float  cblas_cdotu(const int n, const void  *x, const int incx, const void  *y, const int incy);
openblas_complex_float  cblas_cdotc(const int n, const void  *x, const int incx, const void  *y, const int incy);
openblas_complex_double cblas_zdotu(const int n, const void *x, const int incx, const void *y, const int incy);
openblas_complex_double cblas_zdotc(const int n, const void *x, const int incx, const void *y, const int incy);
...
size_t cblas_ismax(const int n, const float  *x, const int incx);
size_t cblas_idmax(const int n, const double *x, const int incx);
size_t cblas_icmax(const int n, const void  *x, const int incx);
size_t cblas_izmax(const int n, const void *x, const int incx);

size_t cblas_ismin(const int n, const float  *x, const int incx);
size_t cblas_idmin(const int n, const double *x, const int incx);
size_t cblas_icmin(const int n, const void  *x, const int incx);
size_t cblas_izmin(const int n, const void *x, const int incx);
